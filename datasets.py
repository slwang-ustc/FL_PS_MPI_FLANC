...
def load_datasets(dataset_type, data_path=cfg['dataset_path']):
    ...
    #     test_dataset = datasets.ImageFolder('/data/ymliao/data/emnist/byclass_test', transform = train_transform)
        ...
        train_dataset = datasets.EMNIST(data_path, split='byclass', train=True, download=True,
        ...
        train_dataset = datasets.ImageFolder('/data/jmyan/dataset/IMAGE100/train', transform=train_transform)
        test_dataset = datasets.ImageFolder('/data/jmyan/dataset/IMAGE100/test', transform=train_transform)
